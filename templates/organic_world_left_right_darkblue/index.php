...
<div class="logo">
 <h1 id="name-text" class="logo-name"><a href="<?php echo $this->baseurl ?>/">OrganicWorld</a></h1>
 <div id="slogan-text" class="logo-text">left-right-Orange</div>
</div>
...
All Rights Reserved.</p>
 ...
 <div class="Footer-background"></div>
  ...
  <p class="page-footer"><a href="http://www.bio-fruchtgummi.de">Gummib&auml;rchen</a>.</p>
